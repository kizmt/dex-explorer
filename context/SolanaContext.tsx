...
export const CLUSTER_LOCAL_STORAGE_KEY = "cluster-dex-explorer";
...
export const CLUSTERS: SolanaCluster[] = [
  {
    ...
    endpoint:process.env.NEXT_PUBLIC_MAINNET_URL || "https://yvette-lb1x3j-fast-mainnet.helius-rpc.com",
  },
  // {
  //   label: "Mainnet (Serum)",
  //   network: "mainnet-beta",
